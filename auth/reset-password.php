    ...
    <section class="pt-36 pb-28 max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-12 gap-6">
            <div class="col-span-12 md:col-span-6 lg:col-span-5 opacity-0 translate-y-8 transition-all duration-700" data-animate>
                ...
                <?php elseif ($token): ?>
                <form method="post" action="reset-password.php?token=<?= h($token) ?>" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="password" id="password" name="password" 
                               class="w-full px-4 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:border-swiss-red transition-colors" required minlength="8" placeholder="At least 8 characters">
                    </div>
                    
                    <div>
                        <label for="password_confirm" class="block text-sm font-medium mb-2">Confirm New Password</label>
                ...
                <div class="mt-8 text-center text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <a href="/auth/forgot-password.php" class="text-swiss-red font-semibold hover:underline">Request new link</a>
                </div>
            </div>
        </div>
    </section>
